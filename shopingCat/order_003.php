...
<![endif]-->
<!-- 檢查名稱;電話;取貨方式 是否為空白 如是就跳出小視窗 如否則執行 form1的action-->
<Script Language="JavaScript"> 
	function checkform() 
	{ 
	
	  if(document.form1.m_phone.value 
	  && document.form1.m_name.value 
	  && document.form1.b_pickup.value)
	  {
			 return true; 
			}
		...
		else if (!document.form1.m_phone.value ) 
	    { 
	      alert("《電話》請勿空白!!"); 
	     // document.form1.m_phone.focus(); 
	     
	    } 
		else  if (!document.form1.b_pickup.value ) 
	    { 
	      alert("《取貨方式》請勿空白!!"); 
	     // document.form1.b_pickup.focus(); 
...
?>
  <form id="form1" name="form1" method="post" action="order_004.php">
    <div align="center"></div>
    <table width="80%" border="2" align="center" cellpadding="5" bgcolor="white" rules="cols">
      <tr height="25">
        <td height="47" colspan="5" align="center" bgcolor="#CCCC00">個人資料</td>
      </tr>
      <tr height="25">
        <td colspan="5">名稱：
          <input name="m_name" type="text" id="m_name" size="35" /></td>
      </tr>
      <tr height="25">
        <td colspan="5">電話：
          <input name="m_phone" type="text" id="m_phone" size="35" /></td>
      </tr>
      <tr height="25">
        <td height="56" colspan="5">地址：
          <input name="m_address" type="text" id="m_adderss" value="外送必填" size="50" /></td>
      </tr>
      <tr height="25">
        <td colspan="5"> 取貨方式：
          <input type="radio" name="b_pickup" id="radio" value="自取" />
          自取
          <input type="radio" name="b_pickup" id="radio" value="外送" />
          <label for="pickup"></label>
          外送(限5杯以上) </td>
      </tr>
      <!--  <tr height="25">
        <td colspan="4"> 付款方式：
          <input type="radio" name="b_payment" id="radio2" value="現金" />
          現金
         
          <input type="radio" name="b_payment" id="radio3" value="預付會員卡" />
          預付會員卡(限自取) 
          </td>
      </tr>-->
      <tr height="25">
        <td colspan="5"> 統一編號：
          <input name="m_unifiednum" type="text" id="m_unifiednum" size="35" /></td>
      </tr>
      <tr height="25">
   ...
   <!-- 檢查是有否有未填入的資料 checkform() in head-->
      <div align="center">
        <input type="submit" name="button" id="button" value="送出訂單 ->GoTo-> 檢視訂單資料" 
